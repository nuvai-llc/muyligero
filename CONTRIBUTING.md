MuyLigero contributing guide
===========
Thanks for your interest in contributing to MuyLigero!

MuyLigero currently has a bit of technical debt that needs to be paid down before any new feature work can resume. Namely, the original site was written in jQuery and is not very maintainable, so a rewrite using Vue.js is in-progress.
...
**2019-05-04 update: The most help we need right now is manually testing the Vue rewrite to ensure it is bug-free and feature-complete with the original version of MuyLigero.**
